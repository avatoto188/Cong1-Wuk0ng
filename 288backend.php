    ...
    <div class="container">
        <header>
            <center><a href="https://ava188.com/LiveChat-Bonus288"><amp-img id="image" class="animated tada infinite slower"
                        src="https://images.pixieset.com/70097088/1f52b3a5aecadbfa0d2afd2c2803975a-xxlarge.png"
                        alt="TOTO TORTOGEL" width="260" height="100" layout="intrinsic"></amp-img></a>
        </header>
        <div class="welcome">
            <h1>TOTO TORTOGEL NO #1 DI DUNIA</h1>
        </div>
